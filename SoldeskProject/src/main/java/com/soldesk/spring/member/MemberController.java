...
public class MemberController {
	...
	public String memberJoin(Member m, HttpServletRequest req, HttpServletResponse res) {
		mDAO.memberLoginCheck(req, res);
	...
	public String memberLogout(Member m, HttpServletRequest req, HttpServletResponse res) {
		mDAO.logout(req, res);
		mDAO.memberLoginCheck(req, res);
		req.setAttribute("content", "home.jsp");
		return "index";
